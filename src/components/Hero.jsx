...
const Hero = () => {
  ...
  return (
    <>
      <div className="w-full md:h-[100vh] h-[70vh] bg-[#0a192f] flex flex-col justify-center items-center bg-cover bg-no-repeat bg-center">
        <Navbar />
        <div className="h-full w-full flex justify-center item-center  text-white ">
          <div className="w-[90%] h-[90%] p-5 flex flex-col justify-center items-center md:items-start  gap-5 rounded-lg text-center">
            ...
            <a
              href="/resume.pdf"
              download
              className="px-4 w-[200px] h-10 flex items-center justify-center border border-[#64ffda] text-[#64ffda] hover:bg-[#64ffda] hover:text-white rounded-sm transition"
            >
              Download Resume
            </a>
          </div>
